...
Meetings are not recorded. Partipication is not graded but I wish to motivate it. Also, I may say something stupid and wouldn't want that held against me.
...
Practical application of a method from previous meeting (`10*4=40` points)
...
You could also use Excel as other studends in this institute.
...
Tidy data: Each row is a  single observaation.
...
Should we start meetings at 9 or 10 o'clock?
