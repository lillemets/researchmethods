...
The standard error in our sample tends to be lower than population standard error. Thus, unlike the estimate of population mean, **population standard error estimate needs to be corrected for bias** as follows:
...
1. Decide the appropriate type I error rate, i.e.  $\alpha$.
...
5. Reject $H_0$ if the value of the test statistic is in the critical region.
